...
The explosion constructer. 


\begin{DoxyParams}{Parameters}
{\em The} & x coordinate of where the explosion starts. \\
\hline
{\em The} & y coordinate of where the explosion starts. \\
\hline
{\em The} & explosion image. this constructor creates an explosion piece \\
\hline
\end{DoxyParams}
...
bounds explosion block to 30 px$\ast$ 30px space 
